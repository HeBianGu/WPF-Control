...
namespace H.Presenters.Common
{
    ...
    {
        public static async Task<bool?> ShowPasswordBox(this IDialogMessageService service, Action<IPasswordBoxPresenter> option, Action<IPasswordBoxPresenter> sumitAction, Action<IDialog> builder = null, Func<bool> canSumit = null)
        {
            return await service.ShowDialog<PasswordBoxPresenter>(option, sumitAction, builder, canSumit);
        }

        public static async Task<bool?> ShowPasswordBox(this IDialogMessageService service, string password, Action<string> sumitAction, Action<IDialog> builder = null, Func<bool> canSumit = null)
        {
