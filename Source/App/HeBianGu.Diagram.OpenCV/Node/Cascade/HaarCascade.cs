...
namespace HeBianGu.Diagram.OpenCV
{
    ...
    public class HaarCascade : CascadeBase
    {
        ...
        protected override IFlowableResult Refresh()
        {
            ...
            // Load the cascades
            var haarCascade = new CascadeClassifier(dataPath);
            // Detect faces
        ...
        string GetDataPathByName()
        {
            ...
            if (this.HaarType == HaarType.RussianPlate)
                return this.GetDataPath(CascadeData.Russian_plate_number);

            throw new ArgumentException("没有识别参数");
        }
    }

    [System.ComponentModel.TypeConverter(typeof(DisplayEnumConverter))]
