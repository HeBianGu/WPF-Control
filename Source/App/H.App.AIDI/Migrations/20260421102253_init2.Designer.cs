...
[Migration("20260421102253_init2")]
partial class init2
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("H.App.AIDI.DB.fm_dd_image", b =>
            {
        ...
        modelBuilder.Entity("H.App.AIDI.DB.fm_dd_label", b =>
            {
                b.Property<string>("ID")
                    .HasColumnType("TEXT")
                    .HasColumnName("id")
        ...
        modelBuilder.Entity("H.App.AIDI.DB.fm_dd_label", b =>
            {
                b.HasOne("H.App.AIDI.DB.fm_dd_image", "Image")
                    .WithMany("Labels")
