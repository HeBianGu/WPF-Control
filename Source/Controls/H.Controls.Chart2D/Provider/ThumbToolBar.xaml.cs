...
namespace H.Controls.Chart2D
{
    ...
    public class ThumbToolBar : ContentControl
    {
        static ThumbToolBar()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ThumbToolBar), new FrameworkPropertyMetadata(typeof(ThumbToolBar)));
        }
        ...
        public static readonly DependencyProperty LeftPercentProperty =
            DependencyProperty.Register("LeftPercent", typeof(double), typeof(ThumbToolBar), new PropertyMetadata(0.2, (l, e) =>
            {
                ThumbToolBar control = l as ThumbToolBar;
        ...
        public static readonly DependencyProperty RightPercentProperty =
            DependencyProperty.Register("RightPercent", typeof(double), typeof(ThumbToolBar), new PropertyMetadata(0.8, (l, e) =>
            {
                ThumbToolBar control = l as ThumbToolBar;
        ...
        public static readonly DependencyProperty MaxValueProperty =
            DependencyProperty.Register("MaxValue", typeof(double), typeof(ThumbToolBar), new PropertyMetadata(100.0, (d, e) =>
             {
                 ThumbToolBar control = d as ThumbToolBar;
        ...
        public static readonly RoutedEvent ValueChangedRoutedEvent =
            EventManager.RegisterRoutedEvent("ValueChanged", RoutingStrategy.Bubble, typeof(EventHandler<RoutedEventArgs>), typeof(ThumbToolBar));
        //CLR事件包装
