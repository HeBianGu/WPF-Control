...
namespace H.Controls.Form.PropertyItem.ObservableCollectionPropertyItems.Base
{
    public abstract class PrimitivesPropertyItemBase : ObjectPropertyItem<ObservableCollection<StringHost>>
    {
        public PrimitivesPropertyItemBase(PropertyInfo property, object obj) : base(property, obj)
        {
