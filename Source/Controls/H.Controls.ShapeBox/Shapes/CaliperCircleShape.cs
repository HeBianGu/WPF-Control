...
public class CaliperCircleShape : PreviewShapeBase
{
    ...
    {
        yield return new ActionCircleHandle(x => this.Center = x, this.Center, this);
        yield return new ActionHandle(x => this.FromRadius = (x - this.Center).Length, new Point(this.Center.X + this.FromRadius, this.Center.Y), this) { Cursor = Cursors.SizeWE };
        yield return new ActionHandle(x => this.ToRadius = (x - this.Center).Length, new Point(this.Center.X + this.ToRadius, this.Center.Y), this) { Cursor = Cursors.SizeWE };
    }
