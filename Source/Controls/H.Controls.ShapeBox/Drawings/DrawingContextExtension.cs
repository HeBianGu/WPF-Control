...
namespace H.Controls.ShapeBox.Drawings
{
    public static class DrawingContextExtension
    {
        ...
        public static void DrawText(this DrawingContext dc, string text, Point point, Brush brush, double fontSize = 10.0)
        {
            FormattedText formattedText = new FormattedText(
                                    ...
                                    fontSize, brush, 1.2);
            dc.DrawText(formattedText, point + new Vector(5, 5));
        }
    }
}
