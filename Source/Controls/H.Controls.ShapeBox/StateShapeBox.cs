...
public class StateShapeBox : SelectShapeBox, IStateShapeView
{
    ...
    {
        this.QueryCursor += this.StateShapeBox_QueryCursor;
    }

    private void StateShapeBox_QueryCursor(object sender, QueryCursorEventArgs e)
    {
        this.GetState()?.QueryCursor(this, e);
    }

    public void UpdateCursor()
    {
        this.RaiseEvent(new QueryCursorEventArgs(Mouse.PrimaryDevice, 0)
        {
    ...
    {
        this.GetState()?.MouseDown(this, e);
        base.OnMouseDown(e);
    }

    protected override void OnMouseLeave(MouseEventArgs e)
    {
        this.GetState()?.MouseLeave(this, e);
        base.OnMouseLeave(e);
    }
    protected override void OnMouseUp(MouseButtonEventArgs e)
    {
        this.GetState()?.MouseUp(this, e);
        base.OnMouseUp(e);
    }

    protected override void OnMouseMove(MouseEventArgs e)
    {
        this.GetState()?.MouseMove(this, e);
        base.OnMouseMove(e);
    }
