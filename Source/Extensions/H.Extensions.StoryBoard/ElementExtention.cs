...
public static class ElementExtention
{
    ...
    {
        DoubleStoryboard engine = DoubleStoryboard.Create(start, end, duration, propertyName);
    ...
    public static bool CheckDefaultTransformGroup(this UIElement element)
    {
        ...
        {
            TransformGroup dg = Application.Current.TryFindResource(StoryBoardKeys.TransformGroup) as TransformGroup;
            if (dg == null)
            {
