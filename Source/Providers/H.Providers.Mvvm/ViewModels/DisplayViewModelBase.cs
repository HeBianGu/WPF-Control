...
{
    public abstract class DisplayViewModelBase : ViewModelBase, IDable
    {
        public DisplayViewModelBase()
        {
            Name = GetType().Name;
    ...
    public class DisplayViewModel<T> : DisplayViewModelBase
    {
        public DisplayViewModel(T t)
        {
            Model = t;
