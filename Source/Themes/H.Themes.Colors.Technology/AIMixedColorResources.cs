...
[Display(Name = "模型锻造", GroupName = "AI混合配色", Description = "深灰黑、电蓝、橙色、绿色混合，适合模型训练和训练日志", Order = 350, Prompt = "混合")]
...
[Display(Name = "张量流光", GroupName = "AI混合配色", Description = "深蓝黑、青色、紫色、琥珀混合，适合算法可视化和特征图展示", Order = 351, Prompt = "混合")]
...
[Display(Name = "神经绽放", GroupName = "AI混合配色", Description = "深紫黑、粉紫、青蓝、柔绿混合，适合 AI 展示页和可视化首页", Order = 352, Prompt = "混合")]
...
[Display(Name = "推理夜航", GroupName = "AI混合配色", Description = "深空蓝、蓝色、青色、黄色混合，适合推理服务监控和实时检测大屏", Order = 353, Prompt = "混合")]
