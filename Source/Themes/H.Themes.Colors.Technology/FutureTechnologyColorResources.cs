...
[Display(Name = "赛博紫", GroupName = "科技未来", Description = "适合 AI、算法和监控大屏的赛博紫深色主题", Order = 400, Prompt = "新增")]
...
[Display(Name = "神经网络蓝", GroupName = "科技未来", Description = "适合 AI 神经网络、算法训练和数据可视化的蓝色主题", Order = 401, Prompt = "新增")]
...
[Display(Name = "量子青", GroupName = "科技未来", Description = "适合量子计算、算法控制台和科技大屏的青色主题", Order = 402, Prompt = "新增")]
...
[Display(Name = "数据流青蓝", GroupName = "科技未来", Description = "适合数据流、实时监控和可视化链路的青蓝主题", Order = 403, Prompt = "新增")]
...
[Display(Name = "全息蓝紫", GroupName = "科技未来", Description = "适合全息视觉、未来界面和科技展示的蓝紫主题", Order = 404, Prompt = "新增")]
...
[Display(Name = "AI 控制台黑蓝", GroupName = "科技未来", Description = "适合 AI 控制台、训练日志和运行监控的黑蓝主题", Order = 405, Prompt = "新增")]
...
[Display(Name = "深空蓝紫", GroupName = "科技未来", Description = "适合深空大屏、科研可视化和未来系统的蓝紫主题", Order = 406, Prompt = "新增")]
...
[Display(Name = "卫星控制台", GroupName = "科技未来", Description = "适合卫星控制、遥测监控和态势大屏的深色主题", Order = 407, Prompt = "新增")]
