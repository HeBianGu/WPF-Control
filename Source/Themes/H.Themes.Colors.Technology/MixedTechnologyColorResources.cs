...
[Display(Name = "极光运维", GroupName = "混合配色", Description = "青蓝、紫色、荧光绿混合，适合监控大屏和运维平台", Order = 1000, Prompt = "混合")]
...
[Display(Name = "霓虹矩阵", GroupName = "混合配色", Description = "矩阵绿、青色、紫粉混合，适合 AI、算法和日志控制台", Order = 1001, Prompt = "混合")]
...
[Display(Name = "赛博日落", GroupName = "混合配色", Description = "玫红、橙色、紫色和青蓝混合，适合科技展示", Order = 1002, Prompt = "混合")]
...
[Display(Name = "海洋信号", GroupName = "混合配色", Description = "湖蓝、蓝色、薄荷绿和黄色混合，适合数据链路和网络监控", Order = 1003, Prompt = "混合")]
...
[Display(Name = "生物科技实验室", GroupName = "混合配色", Description = "医疗蓝、薄荷绿、紫色混合，适合医疗、实验室和 AI 视觉", Order = 1004, Prompt = "混合")]
