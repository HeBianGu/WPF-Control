...
[Display(Name = "森林雾绿", GroupName = "自然舒适", Description = "低饱和森林雾绿，适合长时间工作", Order = 300, Prompt = "低疲劳")]
...
[Display(Name = "海风蓝", GroupName = "自然舒适", Description = "清爽海风蓝，适合低疲劳阅读和办公", Order = 301, Prompt = "低疲劳")]
...
[Display(Name = "山岩灰", GroupName = "自然舒适", Description = "山岩灰蓝中性色，稳定克制", Order = 302, Prompt = "低疲劳")]
...
[Display(Name = "苔藓绿", GroupName = "自然舒适", Description = "柔和苔藓绿，贴近自然", Order = 303, Prompt = "低疲劳")]
...
[Display(Name = "陶土暖棕", GroupName = "自然舒适", Description = "陶土暖棕与米色搭配，温暖柔和", Order = 304, Prompt = "低疲劳")]
...
[Display(Name = "沙漠暖黄", GroupName = "自然舒适", Description = "沙漠暖黄大地色，轻柔不刺眼", Order = 305, Prompt = "低疲劳")]
...
[Display(Name = "湖面晨雾", GroupName = "自然舒适", Description = "湖面晨雾蓝绿灰，清晨感低饱和主题", Order = 306, Prompt = "低疲劳")]
...
[Display(Name = "雨天灰蓝", GroupName = "自然舒适", Description = "雨天灰蓝色，安静克制，适合专注", Order = 307, Prompt = "低疲劳")]
