...
[Display(Name = "薄荷标注", GroupName = "标注办公", Description = "浅纸白、薄荷绿、蓝色、柔灰混合，适合长时间图像标注", Order = 1150, Prompt = "混合")]
...
[Display(Name = "标签工作室", GroupName = "标注办公", Description = "浅暖白、紫色、珊瑚、蓝色混合，适合标签管理和数据整理", Order = 1151, Prompt = "混合")]
...
[Display(Name = "数据集板岩", GroupName = "标注办公", Description = "浅灰蓝、石板灰、蓝色、青色混合，适合数据集列表和样本筛选", Order = 1152, Prompt = "混合")]
...
[Display(Name = "图像实验室", GroupName = "标注办公", Description = "洁净白、医疗蓝、青绿、紫色混合，适合图像增强和图像分析", Order = 1153, Prompt = "混合")]
...
[Display(Name = "专注纸张", GroupName = "低疲劳办公", Description = "纸白、墨蓝、薄荷、琥珀混合，适合长时间阅读和配置", Order = 1200, Prompt = "混合")]
...
[Display(Name = "静谧桌面", GroupName = "低疲劳办公", Description = "浅灰蓝、鼠尾草绿、蓝灰、沙色混合，适合后台、表单和属性面板", Order = 1201, Prompt = "混合")]
...
[Display(Name = "暖色笔记", GroupName = "低疲劳办公", Description = "奶油白、咖啡棕、桃色、金色混合，适合轻办公和日志", Order = 1202, Prompt = "混合")]
...
[Display(Name = "柔和仪表盘", GroupName = "低疲劳办公", Description = "浅白、天蓝、薄荷、淡紫混合，适合浅色看板和统计界面", Order = 1203, Prompt = "混合")]
