...
[Display(Name = "行政蓝", GroupName = "专业办公", Description = "蓝灰稳重，适合后台、管理系统、生产平台", Order = 100, Prompt = "办公")]
...
[Display(Name = "企业灰", GroupName = "专业办公", Description = "中性低干扰，适合长时间办公", Order = 101, Prompt = "办公")]
...
[Display(Name = "金融海军蓝", GroupName = "专业办公", Description = "深海军蓝，适合金融、报表和审批系统", Order = 102, Prompt = "办公")]
...
[Display(Name = "文档墨蓝", GroupName = "专业办公", Description = "墨蓝文档风，适合资料管理和文书系统", Order = 103, Prompt = "办公")]
...
[Display(Name = "医疗洁净白蓝", GroupName = "专业办公", Description = "洁净白蓝，适合医疗、影像和健康管理", Order = 104, Prompt = "办公")]
...
[Display(Name = "科研论文浅色", GroupName = "专业办公", Description = "论文纸张浅色，适合科研、实验和阅读", Order = 105, Prompt = "办公")]
...
[Display(Name = "咖啡奶油", GroupName = "暖色人文", Description = "咖啡与奶油色，适合创作、阅读和轻办公", Order = 120, Prompt = "暖色")]
...
[Display(Name = "复古纸张", GroupName = "暖色人文", Description = "复古纸张色，适合阅读和文档编辑", Order = 121, Prompt = "暖色")]
...
[Display(Name = "日落珊瑚", GroupName = "暖色人文", Description = "日落珊瑚色，适合创作和轻量办公", Order = 122, Prompt = "暖色")]
...
[Display(Name = "秋枫橙红", GroupName = "暖色人文", Description = "秋枫橙红色，适合阅读和创意工作", Order = 123, Prompt = "暖色")]
...
[Display(Name = "暖琥珀", GroupName = "暖色人文", Description = "暖琥珀色，适合轻办公和数据阅读", Order = 124, Prompt = "暖色")]
...
[Display(Name = "书店暖棕", GroupName = "暖色人文", Description = "书店暖棕色，适合知识库、阅读和文档管理", Order = 125, Prompt = "暖色")]
...
[Display(Name = "肉桂棕", GroupName = "暖色人文", Description = "肉桂棕色，温暖柔和，适合轻办公", Order = 126, Prompt = "暖色")]
...
[Display(Name = "老电影黄褐", GroupName = "暖色人文", Description = "老电影黄褐色，适合复古、阅读和文艺办公", Order = 127, Prompt = "暖色")]
