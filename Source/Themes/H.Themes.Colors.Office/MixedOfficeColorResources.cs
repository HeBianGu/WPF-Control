...
[Display(Name = "纸张薄荷", GroupName = "混合配色", Description = "纸白、墨绿、薄荷、蓝灰混合，适合阅读、标注和长时间办公", Order = 1000, Prompt = "混合")]
...
[Display(Name = "暖色工作室", GroupName = "混合配色", Description = "奶油白、咖啡棕、珊瑚和琥珀混合，适合创作、轻办公和文档管理", Order = 1001, Prompt = "混合")]
