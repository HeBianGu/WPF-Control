...
[Display(Name = "海洋图表", GroupName = "数据可视化", Description = "适合图表、仪表盘、统计界面的海洋蓝主题", Order = 100, Prompt = "数据可视化")]
...
[Display(Name = "糖果图表", GroupName = "数据可视化", Description = "适合轻量统计和多彩图表的糖果色主题", Order = 101, Prompt = "数据可视化")]
...
[Display(Name = "科学图表", GroupName = "数据可视化", Description = "适合科研统计、实验数据和严谨图表的浅色主题", Order = 102, Prompt = "数据可视化")]
...
[Display(Name = "交通图表", GroupName = "数据可视化", Description = "适合交通流量、路线监控和信号统计的深色主题", Order = 103, Prompt = "数据可视化")]
...
[Display(Name = "能源图表", GroupName = "数据可视化", Description = "适合能源、电网、功耗和趋势分析的深色主题", Order = 104, Prompt = "数据可视化")]
...
[Display(Name = "热力图表", GroupName = "数据可视化", Description = "适合热力图、密度图和风险态势的深色主题", Order = 105, Prompt = "数据可视化")]
...
[Display(Name = "夜间仪表盘", GroupName = "数据可视化", Description = "适合监控大屏和夜间仪表盘的深色主题", Order = 106, Prompt = "数据可视化")]
...
[Display(Name = "监控绿色", GroupName = "数据可视化", Description = "适合监控、指标状态和运行日志的绿色深色主题", Order = 107, Prompt = "数据可视化")]
...
[Display(Name = "指标蓝", GroupName = "数据可视化", Description = "适合 KPI、指标卡片和管理看板的蓝色浅色主题", Order = 108, Prompt = "数据可视化")]
...
[Display(Name = "分析紫", GroupName = "数据可视化", Description = "适合分析报表、统计洞察和趋势图的紫色浅色主题", Order = 109, Prompt = "数据可视化")]
