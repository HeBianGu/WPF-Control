...
[Display(Name = "洞察棱镜", GroupName = "洞察看板", Description = "深蓝紫、紫色、青色、粉色混合，适合综合看板和趋势洞察", Order = 1300, Prompt = "混合")]
...
[Display(Name = "报表画布", GroupName = "洞察看板", Description = "浅白灰、蓝色、紫色、琥珀混合，适合管理报表和统计分析", Order = 1301, Prompt = "混合")]
...
[Display(Name = "指标极光", GroupName = "洞察看板", Description = "深蓝黑、青色、绿色、紫色混合，适合 KPI、指标卡片和监控大屏", Order = 1302, Prompt = "混合")]
...
[Display(Name = "风险热图", GroupName = "洞察看板", Description = "深棕黑、红色、橙色、黄色、蓝色混合，适合风险热力图和异常分布", Order = 1303, Prompt = "混合")]
