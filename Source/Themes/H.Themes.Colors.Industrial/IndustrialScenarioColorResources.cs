...
[Display(Name = "钢铁灰蓝", GroupName = "工业制造", Description = "适合工控和设备监控的钢铁灰蓝主题", Order = 500, Prompt = "新增")]
...
[Display(Name = "安全橙黑", GroupName = "工业制造", Description = "适合警示与安全看板的橙黑主题", Order = 501, Prompt = "新增")]
...
[Display(Name = "机床绿", GroupName = "工业制造", Description = "适合机床、产线和设备操作台的绿色主题", Order = 502, Prompt = "新增")]
...
[Display(Name = "警示琥珀", GroupName = "工业制造", Description = "适合设备状态、报警和能耗监控的琥珀主题", Order = 503, Prompt = "新增")]
...
[Display(Name = "车间深灰", GroupName = "工业制造", Description = "适合车间大屏和设备监控的深灰主题", Order = 504, Prompt = "新增")]
...
[Display(Name = "控制室蓝黑", GroupName = "工业制造", Description = "适合调度中心和控制室的蓝黑主题", Order = 505, Prompt = "新增")]
...
[Display(Name = "AI视觉深色", GroupName = "行业场景", Description = "适合 AI 视觉检测和图像分析的深色主题", Order = 540, Prompt = "新增")]
...
[Display(Name = "标注工具蓝", GroupName = "行业场景", Description = "适合数据标注和图像列表管理的蓝色主题", Order = 541, Prompt = "新增")]
...
[Display(Name = "训练控制台", GroupName = "行业场景", Description = "适合模型训练、日志输出和控制台监控的主题", Order = 542, Prompt = "新增")]
...
[Display(Name = "数据集管理", GroupName = "行业场景", Description = "适合数据集、标签和文件管理的浅色主题", Order = 543, Prompt = "新增")]
...
[Display(Name = "安全运营", GroupName = "行业场景", Description = "适合安全运营和告警态势的深色主题", Order = 544, Prompt = "新增")]
...
[Display(Name = "医学影像", GroupName = "行业场景", Description = "适合医学影像阅片和医疗分析的浅色主题", Order = 545, Prompt = "新增")]
...
[Display(Name = "地图遥感深色", GroupName = "行业场景", Description = "适合地图、遥感和地理分析的深色主题", Order = 546, Prompt = "新增")]
...
[Display(Name = "实验仪器", GroupName = "行业场景", Description = "适合实验室仪器和测量系统的浅色主题", Order = 547, Prompt = "新增")]
...
[Display(Name = "能源电网", GroupName = "行业场景", Description = "适合能源、电力和电网监控的深色主题", Order = 548, Prompt = "新增")]
...
[Display(Name = "交通调度", GroupName = "行业场景", Description = "适合交通调度、信号监控和路线分析的深色主题", Order = 549, Prompt = "新增")]
