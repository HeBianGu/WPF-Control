...
[Display(Name = "石墨脉冲", GroupName = "混合配色", Description = "石墨黑、灰蓝、电蓝、橙色和绿色混合，适合专业后台和工业平台", Order = 1250, Prompt = "混合")]
...
[Display(Name = "指挥中心", GroupName = "混合配色", Description = "蓝黑、蓝色、青色、警示橙和红色混合，适合调度中心和生产大屏", Order = 1251, Prompt = "混合")]
