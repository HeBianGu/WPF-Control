...
[Display(Name = "产线脉冲", GroupName = "工业混合配色", Description = "深灰黑、安全橙、绿色、蓝色混合，适合生产线状态和设备监控", Order = 1252, Prompt = "混合")]
...
[Display(Name = "告警看板", GroupName = "工业混合配色", Description = "深红黑、红色、琥珀、白色混合，适合异常报警和风险看板", Order = 1253, Prompt = "混合")]
...
[Display(Name = "质量关卡", GroupName = "工业混合配色", Description = "深蓝灰、绿色、黄色、红色混合，适合质检、良率统计和质量评估", Order = 1254, Prompt = "混合")]
...
[Display(Name = "运维雷达", GroupName = "工业混合配色", Description = "深蓝黑、雷达绿、青色、黄色混合，适合系统运行监控和资源监控", Order = 1255, Prompt = "混合")]
