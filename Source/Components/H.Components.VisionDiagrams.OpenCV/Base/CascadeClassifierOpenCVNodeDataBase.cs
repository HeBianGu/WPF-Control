...
global using H.Components.VisionDiagram.Base;
global using H.Components.VisionDiagram.NodeDataGroups;
...
public abstract class CascadeClassifierOpenCVNodeDataBase : OpenCVNodeDataBase, IOtherGroupableNodeData
{
    ...
    [Display(Name = "缩放比例", GroupName = VisionTabNames.RunParameters, Description = "图像缩放比例(1.01-1.5)，用于多尺度检测")]
    ...
    [DefaultValue(3)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "邻近数目", GroupName = VisionTabNames.RunParameters, Description = "候选矩形保留的邻近数目，值越大检测越严格")]
