...
public class ResizeNodeData : OpenCVNodeDataBase, IPreprocessingGroupableNodeData
{
    ...
    [Display(Name = "缩放模式", GroupName = VisionTabNames.RunParameters, Description = "选择按固定尺寸或比例调整图像大小")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "固定尺寸", GroupName = VisionTabNames.RunParameters, Description = "设置缩放后图像的目标宽度和高度")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "比例", GroupName = VisionTabNames.RunParameters, Description = "设置图像宽度和高度的缩放比例")]
    public double Scale
    {
        get { return _scale; }
        set
