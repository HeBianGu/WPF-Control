...
public class MultiplayDivideNodeData : OpenCVNodeDataBase, IPreprocessingGroupableNodeData
{
    ...
    [Display(Name = "数值", GroupName = VisionTabNames.RunParameters, Description = "设置与每个图像像素执行乘除运算的数值")]
    public double Value
    {
        get { return _value; }
        set
