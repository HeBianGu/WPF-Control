...
public class RepeatNodeData : OpenCVNodeDataBase, IPreprocessingGroupableNodeData
{
    ...
    [Display(Name = "Y重复个数", GroupName = VisionTabNames.RunParameters, Description = "设置图像在垂直方向重复排列的次数")]
    ...
    [GetMethodNameSource(nameof(GetIntFromExpressionKeys))]
    [PropertyItem(typeof(InputExpressionComboBoxTextPropertyItem<int>))]
    [Display(Name = "X重复个数", GroupName = VisionTabNames.RunParameters, Description = "设置图像在水平方向重复排列的次数")]
