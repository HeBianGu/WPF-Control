...
public class PowNodeData : OpenCVNodeDataBase, IPreprocessingGroupableNodeData
{
...
public class TransposeNodeData : OpenCVNodeDataBase, IPreprocessingGroupableNodeData
{
    protected override FlowableResult<IMatImage> Invoke(Mat fromImage)
    {
        Mat result = new Mat();
...
//    [Display(Name = "方式", GroupName = VisionTabNames.RunParameters)]
