...
public class Resize : OpenCVNodeDataBase, IPreprocessingGroupableNodeData
{
    ...
    [Display(Name = "缩放模式", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "固定尺寸", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "比例", GroupName = VisionTabNames.RunParameters)]
    public double Scale
    {
        get { return _scale; }
        set
