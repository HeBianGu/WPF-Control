...
public class BlobDetectorNodeData : OpenCVDetectorNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [Display(Name = "形状类型", GroupName = VisionTabNames.RunParameters, Description = "选择斑点检测结果转换成的几何形状类型")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "阈值步长", GroupName = VisionTabNames.RunParameters, Description = "设置斑点检测遍历二值化阈值时的递增步长")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小阈值", GroupName = VisionTabNames.RunParameters, Description = "设置斑点检测使用的最小二值化阈值")]
    ...
    [DefaultValue(220f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大阈值", GroupName = VisionTabNames.RunParameters, Description = "设置斑点检测使用的最大二值化阈值")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小重复性", GroupName = VisionTabNames.RunParameters, Description = "设置候选斑点在不同阈值下被重复检测的最少次数")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小斑点间距", GroupName = VisionTabNames.RunParameters, Description = "设置两个独立斑点中心之间允许的最小距离")]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按颜色过滤", GroupName = VisionTabNames.RunParameters, Description = "指定是否按二值图中的斑点颜色进行过滤")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "颜色", GroupName = VisionTabNames.RunParameters, Description = "设置需要保留的斑点颜色值")]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按面积过滤", GroupName = VisionTabNames.RunParameters, Description = "指定是否按斑点像素面积进行过滤")]
    ...
    [DefaultValue(100f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小面积（像素）", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点区域的最小像素面积")]
    ...
    [DefaultValue(10000f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大面积（像素）", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点区域的最大像素面积")]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按圆形度过滤", GroupName = VisionTabNames.RunParameters, Description = "指定是否按斑点轮廓圆形度进行过滤")]
    ...
    [DefaultValue(0.8f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小圆形度", GroupName = VisionTabNames.RunParameters, Description = "最小圆形度（1为完美圆）")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大圆形度", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点轮廓的最大圆形度")]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按惯性比过滤", GroupName = VisionTabNames.RunParameters, Description = "指定是否按斑点主轴惯性比进行过滤")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小惯性比", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点形状的最小惯性比")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大惯性比", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点形状的最大惯性比")]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按凸性过滤", GroupName = VisionTabNames.RunParameters, Description = "指定是否按斑点轮廓凸性进行过滤")]
    ...
    [DefaultValue(0.87f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小凸性", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点轮廓的最小凸性")]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大凸性", GroupName = VisionTabNames.RunParameters, Description = "设置允许斑点轮廓的最大凸性")]
