...
public class HoughLinesNodeData : HoughLinesNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "细化距离分辨率", GroupName = VisionTabNames.RunParameters, Description = "控制距离分辨率(rho)的细化程度")]
    public double Srn
    {
        get { return _srn; }
        set
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "细化角度分辨率", GroupName = VisionTabNames.RunParameters, Description = "控制角度分辨率(theta)的细化程度")]
    public double Stn
    {
        get { return _stn; }
        set
