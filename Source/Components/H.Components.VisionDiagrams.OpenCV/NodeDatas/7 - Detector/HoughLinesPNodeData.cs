...
public class HoughLinesPNodeData : HoughLinesNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [Tab(VisionTabNames.RunParameters)]
    [DefaultValue(true)]
    [Display(Name = "位置修正", GroupName = "位置修正", Description = "指定是否根据参考信息修正线段位置")]
    ...
    [Display(Name = "修正信息", GroupName = "位置修正", Description = "设置线段位置修正使用的平移和旋转信息")]
...
{
    [Display(Name = "全部", GroupName = "筛选方式", Description = "保留检测到的所有线段")]
    All,
    [Display(Name = "最短线段", GroupName = "筛选方式", Description = "从检测结果中保留长度最小的线段")]
    MinLength,
    [Display(Name = "最长线段", GroupName = "筛选方式", Description = "从检测结果中保留长度最大的线段")]
    MaxLength,
    [Display(Name = "卡尺筛选", GroupName = "筛选方式", Description = "仅保留位于卡尺区域内的线段")]
    Caliper
}
...
public abstract class HoughLinesNodeDataBase : OpenCVDetectorNodeDataBase
{
