...
public class FindContoursNodeData : OpenCVDetectorNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [DefaultValue(null)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "查找偏移量", GroupName = VisionTabNames.RunParameters, Description = "在FindContours时为所有坐标应用的偏移量（X,Y）。用于对输入坐标进行整体平移。")]
    ...
    [DefaultValue(-1)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "轮廓索引", GroupName = VisionTabNames.RunParameters, Description = "指定绘制的轮廓索引；-1表示绘制所有轮廓。与MaxLevel、RetrievalMode组合使用。")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "线型", GroupName = VisionTabNames.RunParameters, Description = "绘制轮廓时的线段连接类型，如8连接、4连接、抗锯齿。影响线条显示效果。")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大层级", GroupName = VisionTabNames.RunParameters, Description = "绘制轮廓时的层级深度：0仅绘制指定索引，1包含其子级，以此类推；设为int.MaxValue绘制所有层级。")]
    public int MaxLevel
    {
    ...
    [DefaultValue(null)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "绘制偏移量", GroupName = VisionTabNames.RunParameters, Description = "在绘制轮廓时对所有点应用的偏移量（X,Y）。用于整体平移绘制位置。")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "识别轮廓类型", GroupName = VisionTabNames.RunParameters, Description = "选择轮廓检索的层级组织方式")]
    ...
    [Display(Name = "绘制结果方式", GroupName = VisionTabNames.DisplayParameters, Description = "选择检测结果使用的几何绘制方式")]
    ...
    [DefaultValue(-1)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "筛选最大面积", GroupName = VisionTabNames.RunParameters, Description = "按面积过滤结果数据最大值")]
    ...
    [DefaultValue(-1)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "筛选最小面积", GroupName = VisionTabNames.RunParameters, Description = "按面积过滤结果数据最大值")]
    ...
    [Display(Name = "最小外接矩形", GroupName = VisionTabNames.ResultParameters, Description = "按面积过滤结果数据最大值")]
...
{
    [Display(Name = "轮廓", GroupName = "绘制方式", Description = "绘制检测到的原始轮廓")]
    DrawContours = 0,
    [Display(Name = "外接矩形", GroupName = "绘制方式", Description = "绘制与坐标轴平行的轮廓外接矩形")]
    BoundingRect,
    [Display(Name = "最小外接矩形", GroupName = "绘制方式", Description = "绘制面积最小的旋转外接矩形")]
    MinAreaRect,
    [Display(Name = "凸包", GroupName = "绘制方式", Description = "绘制包围轮廓的最小凸多边形")]
    ConvexHull,
    [Display(Name = "近似多边形拟合", GroupName = "绘制方式", Description = "绘制经过多边形近似后的轮廓")]
    ApproxPolyDP
}
