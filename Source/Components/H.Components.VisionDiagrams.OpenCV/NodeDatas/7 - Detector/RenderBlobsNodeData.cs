...
[Display(Name = "连通区域查找", GroupName = "查找", Description = "查找二值图像中的连通区域并生成轮廓结果", Order = 3)]
public class RenderBlobsNodeData : OpenCVDetectorNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [Display(Name = "像素连通性", GroupName = VisionTabNames.RunParameters, Description = "像素连通性是指在图像处理操作中如何定义像素之间的连接关系")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "连通算法类型", GroupName = VisionTabNames.RunParameters, Description = "选择四邻域或八邻域连通区域分析方式")]
    ...
    [DefaultValue(100.0)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小面积", GroupName = VisionTabNames.RunParameters, Description = "过滤面积小于该值的连通区域")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大面积", GroupName = VisionTabNames.RunParameters, Description = "过滤面积大于该值的连通区域")]
    ...
    [Display(Name = "渲染连通区域", GroupName = VisionTabNames.DisplayParameters, Description = "指定是否使用不同颜色填充检测到的连通区域")]
    ...
    [Tab(VisionTabNames.DisplayParameters)]
    [Display(Name = "绘制结果方式", GroupName = VisionTabNames.DisplayParameters, Description = "选择连通区域结果的轮廓或边框绘制方式")]
