...
public class BlobDetector : OpenCVDetectorNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [Display(Name = "形状类型", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "阈值步长", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小阈值", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小重复性", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小块间距离", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按颜色过滤", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "颜色", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按面积过滤", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(100f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小面积（像素）", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10000f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大面积（像素）", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按圆形度过滤", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大圆形度", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "惯性过滤", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小惯性比", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大惯性比", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "按凸性过滤", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(0.87f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小凸性", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(10.0f)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大凸性", GroupName = VisionTabNames.RunParameters)]
