...
public class HoughCirclesNodeData : OpenCVDetectorNodeDataBase, IDetectorGroupableNodeData
{
    private HoughModes _HoughModes = HoughModes.Gradient;
    [DefaultValue(HoughModes.GradientAlt)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "检测类型", GroupName = VisionTabNames.RunParameters, Description = "选择霍夫圆检测结果的筛选类型")]
    ...
    [Display(Name = "绘制结果方式", GroupName = VisionTabNames.DisplayParameters, Description = "选择多个圆检测结果的筛选和绘制方式")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [DefaultValue(true)]
    [Display(Name = "位置修正", GroupName = "位置修正", Description = "指定是否根据参考信息修正圆的位置")]
    ...
    [Display(Name = "修正信息", GroupName = "位置修正", Description = "设置圆位置修正使用的平移和旋转信息")]
...
{
    [Display(Name = "全部", GroupName = "筛选方式", Description = "保留检测到的所有圆")]
    All = 0,
    [Display(Name = "最小半径", GroupName = "筛选方式", Description = "从检测结果中保留半径最小的圆")]
    MinRadius = 1,
    [Display(Name = "最大半径", GroupName = "筛选方式", Description = "从检测结果中保留半径最大的圆")]
    MaxRadius = 2,
    [Display(Name = "卡尺筛选", GroupName = "筛选方式", Description = "仅保留位于卡尺区域内的圆")]
    Caliper = 3,
}