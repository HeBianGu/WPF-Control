...
public class RenderBlobs : OpenCVDetectorNodeDataBase, IDetectorGroupableNodeData
{
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "连通算法类型", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(100.0)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小面积", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大面积", GroupName = VisionTabNames.RunParameters)]
    ...
    [Display(Name = "渲染联通区域", GroupName = VisionTabNames.DisplayParameters)]
