...
public class CornerHarrisNodeData : PointDetectorNodeDataBase, IDetectorGroupableNodeData
{
    private int _blockSize = 2;
    [DefaultValue(2)]
    [Range(1, 50)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "Block 大小", GroupName = VisionTabNames.RunParameters, Description = "用于计算协方差矩阵的邻域大小")]
    ...
    [Range(1, 31)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "Sobel 核大小", GroupName = VisionTabNames.RunParameters, Description = "Sobel 算子孔径大小（建议奇数：3/5/7/…）")]
    public int Ksize
    {
        get { return _ksize; }
        set
    ...
    [Range(0.01, 0.2)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "Harris k", GroupName = VisionTabNames.RunParameters, Description = "Harris 响应函数经验系数")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "BorderTypes", GroupName = VisionTabNames.RunParameters, Description = "BorderTypes 响应函数经验系数")]
    ...
    [Range(0.0, 255.0)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "响应阈值", GroupName = VisionTabNames.RunParameters, Description = "归一化到 0~255 后的角点响应阈值")]
