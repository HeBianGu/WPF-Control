...
public class SeamlessCloneBackgroundNodeData : OpenCVNodeDataBase, ITakeoffGroupableNodeData
{
    public SeamlessCloneBackgroundNodeData()
    {
        this.BackgroundFilePath = "Assets\\OpenCV\\asahiyama.jpg";
    }

    private IExpressionKey _ForegroundImageExpression;
    ...
    [Display(Name = "前景图像", GroupName = VisionTabNames.RunParameters, Description = "选择应用掩码的前景图像")]
    public IExpressionKey ForegroundImageExpression
    {
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "背景图片", GroupName = VisionTabNames.RunParameters, Description = "设置无缝融合使用的目标背景图像")]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "启用无缝融合", GroupName = VisionTabNames.RunParameters, Description = "指定是否使用泊松无缝克隆融合前景和背景")]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "启用背景模糊", GroupName = VisionTabNames.RunParameters, Description = "指定融合前是否对背景图像进行模糊处理")]
    public bool UseBlur
    {
        get { return _useBlur; }
        set
    ...
    [Display(Name = "启用步骤输出", GroupName = VisionTabNames.DisplayParameters, Description = "指定是否输出无缝融合过程中的中间图像")]
    ...
    protected override FlowableResult<IMatImage> Invoke(Mat fromImage)
    {
        ...
        Mat src = fromImage;
        var r = this.GetExpressionValue<MatImage>(this.ForegroundImageExpression);
        if (!r.success)
            return this.Error(fromImage.Clone(), "前景图像表达式获取失败");
        src = r.value.Mat;
