...
public class HSVInRangeNodeData : OpenCVNodeDataBase, ITakeoffGroupableNodeData, IColorNodeData
{
    ...
    [Display(Name = "启用二值分割", GroupName = VisionTabNames.RunParameters, Description = "禁用时可以从工具栏中拾取来源图像主色")]
