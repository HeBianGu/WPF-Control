...
public class SeamlessCloneBackground : OpenCVNodeDataBase, ITakeoffGroupableNodeData
{
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "背景图片", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "启用无缝融合", GroupName = VisionTabNames.RunParameters)]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "启用背景模糊", GroupName = VisionTabNames.RunParameters)]
    public bool UseBlur
    {
        get { return _useBlur; }
        set
    ...
    [Display(Name = "启用步骤输出", GroupName = VisionTabNames.DisplayParameters)]
