...
public class SrcVideoFilesNodeData : VideoCaptureNodeDataBase, ISrcImageGroupableNodeData, ISrcVideoFilesNodeData
{
    ...
    public override async Task<IFlowableResult> InvokeAsync(IFlowableLinkData previors, IFlowableDiagramData diagram)
    {
        ...
        return await Task.Run(async () =>
        {
            ...
            using VideoCapture capture = new VideoCapture(this.SrcFilePath.SrcFilePath);
    ...
    protected override void AddFiles()
    {
        IocMessage.IOFolderDialog.ShowOpenFolderAction(x =>
        {
            ...
            this.SrcFilePaths.AddRange(images.Select(image => new SrcFilePathData { SrcFilePath = image }));
