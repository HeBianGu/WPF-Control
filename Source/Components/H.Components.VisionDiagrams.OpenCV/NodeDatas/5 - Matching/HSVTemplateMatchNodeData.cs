...
using H.Components.VisionDiagrams.OpenCV.NodeDatas.Detector;
using H.Controls.ShapeBox.State.Base;

namespace H.VisionMaster.OpenCVs.TemplateMatch.NodeDatas;

[Icon(FontIcons.Color)]
[Display(Name = "颜色匹配", GroupName = "模板匹配", Description = "根据 HSV 颜色范围定位并筛选目标区域", Order = 0)]
public class HSVTemplateMatchNodeData : RenderBlobsNodeData, ITemplateMatchingGroupableNodeData, IColorNodeData
{
    ...
    [Display(Name = "设置主色", GroupName = VisionTabNames.RunParameters, Description = "从图片提取颜色或手动设置色相")]
    public Color Color
    {
        get { return _Color; }
        set
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "H色相生成范围", GroupName = VisionTabNames.RunParameters, Description = "用于控制吸管工具生成上下限参数")]
    [DefaultValue(35)]
    [Range(0, 85)]
    public int hRange
    {
    ...
    [PropertyItem(typeof(Int32SliderTextPropertyItem))]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "S饱和度生成范围", GroupName = VisionTabNames.RunParameters, Description = "用于控制吸管工具生成上下限参数")]
    [DefaultValue(30)]
    [Range(0, 255)]
    public int sRange
    {
    ...
    [PropertyItem(typeof(Int32SliderTextPropertyItem))]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "V明度生成范围", GroupName = VisionTabNames.RunParameters, Description = "用于控制吸管工具生成上下限参数")]
    [DefaultValue(30)]
    [Range(0, 255)]
    public int vRange
    {
