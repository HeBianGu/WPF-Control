...
[Display(Name = "形状匹配", GroupName = "模板匹配", Description = "使用形状匹配算法在图像中查找与模板相似的轮廓", Order = 3)]
public class ShapeTemplateMatchNodeData : MatchingNodeData<IMatImage>, ITemplateMatchingGroupableNodeData, IRectCropable, IOpenCVNodeData
{
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小匹配分数", GroupName = VisionTabNames.RunParameters, Description = "设置形状匹配结果被接受的最低相似度", Order = 0)]
    [Range(0.0, 1.0)]
    ...
    [DefaultValue(100.0)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最小轮廓面积", GroupName = VisionTabNames.RunParameters, Description = "过滤面积小于该值的候选轮廓", Order = 1)]
    ...
    [DefaultValue(-1)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最大轮廓面积", GroupName = VisionTabNames.RunParameters, Description = "过滤面积大于该值的候选轮廓", Order = 2)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "匹配模式", GroupName = VisionTabNames.RunParameters, Description = "选择轮廓形状相似度的计算方式", Order = 3)]
    ...
    [Display(Name = "显示绘制结果箭头", GroupName = VisionTabNames.DisplayParameters, Description = "指定是否绘制匹配目标的方向箭头", Order = 2)]
    ...
    [DefaultValue(false)]
    [Tab(VisionTabNames.DisplayParameters)]
    [Display(Name = "显示绘制结果标尺", GroupName = VisionTabNames.DisplayParameters, Description = "指定是否绘制匹配目标的尺寸标尺", Order = 2)]
    ...
    [DefaultValue(true)]
    [Tab(VisionTabNames.DisplayParameters)]
    [Display(Name = "显示绘制结果标题", GroupName = VisionTabNames.DisplayParameters, Description = "指定是否绘制匹配结果的标题文本", Order = 2)]
    ...
    [DefaultValue(null)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "形状模板数据", GroupName = VisionTabNames.RunParameters, Description = "设置用于轮廓匹配的形状模板数据", Order = 3)]
...
public class PointssShapeViewPropertyItem : ShapeViewPropertyItem
{
    ...
    [Display(Name = "模板设置", GroupName = CommandGroupNames.QuickAccessToolbar, Description = "打开形状模板配置界面")]
    public DisplayCommand ShowTemplateManagerCommand => new DisplayCommand(async x =>
    {
            if (this.Obj is ShapeTemplateMatchNodeData nodeData)
        {
    ...
    [Display(Name = "删除模板", GroupName = CommandGroupNames.QuickAccessToolbar, Description = "删除当前保存的形状模板")]
