...
public class FeaturePointTemplateMatch : MatchingNodeData<IMatImage>, ITemplateMatchingGroupableNodeData, IRectCropable, IBase64MatchingNodeData, IOpenCVNodeData
{
    ...
    [Display(Name = "保留匹配点数", GroupName = VisionTabNames.RunParameters, Order = 0)]
    [Range(4, 100)]
    ...
    [PropertyItem(typeof(Int32SliderTextPropertyItem))]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "最少匹配点数", GroupName = VisionTabNames.RunParameters, Order = 1)]
    [Range(4, 100)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "特征模板数据", GroupName = VisionTabNames.RunParameters, Order = 3)]
