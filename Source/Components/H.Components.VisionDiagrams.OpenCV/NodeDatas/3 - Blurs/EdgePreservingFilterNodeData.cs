...
public class EdgePreservingFilterNodeData : OpenCVNodeDataBase, IBlurGroupableNodeData
{
    ...
    [Display(Name = "滤波方式", GroupName = VisionTabNames.RunParameters, Description = "选择边缘保持滤波使用的递归或归一化卷积方式")]
