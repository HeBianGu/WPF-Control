...
public class StarFeatureDetector : FeatureOpenCVNodeDataBase
{
    ...
    [Display(Name = "MaxSize", GroupName = VisionTabNames.RunParameters)]
    public int MaxSize
    {
        get { return _maxSize; }
        set
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "ResponseThreshold", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "LineThresholdProjected", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "LineThresholdBinarized", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "SuppressNonmaxSize", GroupName = VisionTabNames.RunParameters)]
