...
public class HomographyTransformNodeData : OpenCVNodeDataBase
{
    ...
    [Display(Name = "源点", GroupName = VisionTabNames.RunParameters, Description = "设置单应性变换前的源坐标点集合")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "目标点", GroupName = VisionTabNames.RunParameters, Description = "设置与源点一一对应的目标坐标点集合")]
