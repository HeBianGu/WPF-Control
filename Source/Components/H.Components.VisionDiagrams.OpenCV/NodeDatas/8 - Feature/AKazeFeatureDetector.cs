...
public class AKazeFeatureDetector : FeatureOpenCVNodeDataBase
{
    ...
    [Display(Name = "DescriptorType", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "DescriptorSize", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "DescriptorChannels", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "nOctaveLayers", GroupName = VisionTabNames.RunParameters)]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "Diffusivity", GroupName = VisionTabNames.RunParameters)]
