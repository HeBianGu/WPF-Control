...
public abstract class SeamlessCloneNodeDataBase : OpenCVNodeDataBase
{
    ...
    [Display(Name = "融合方式", GroupName = VisionTabNames.RunParameters, Description = "选择普通、混合或单色传输无缝克隆方式")]
...
public class SeamlessCloneNodeData : SeamlessCloneNodeDataBase, IOtherGroupableNodeData
{
    public SeamlessCloneNodeData()
    {
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "前景图片路径", GroupName = VisionTabNames.RunParameters, Description = "设置需要融合到目标图像中的前景图片路径")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "放置位置", GroupName = VisionTabNames.RunParameters, Description = "设置前景图像中心在目标图像中的放置坐标")]
