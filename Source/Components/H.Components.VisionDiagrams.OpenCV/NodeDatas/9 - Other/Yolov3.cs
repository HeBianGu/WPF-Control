...
public class Yolov3 : OpenCVNodeDataBase, IOtherGroupableNodeData
{
    ...
    [Display(Name = "Cfg路径", GroupName = VisionTabNames.RunParameters)]
    ...
    [Required]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "Weight路径", GroupName = VisionTabNames.RunParameters)]
    [PropertyItem(typeof(OpenFileDialogPropertyItem))]
    ...
    [Required]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "标签路径", GroupName = VisionTabNames.RunParameters)]
    [PropertyItem(typeof(OpenFileDialogPropertyItem))]
