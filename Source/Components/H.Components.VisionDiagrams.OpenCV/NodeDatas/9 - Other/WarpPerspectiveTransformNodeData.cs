...
public class WarpPerspectiveTransformNodeData : OpenCVNodeDataBase, IOtherGroupableNodeData
{
    ...
    [Display(Name = "源点", GroupName = VisionTabNames.RunParameters, Description = "设置用于计算透视矩阵的四个源坐标点")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "目标点", GroupName = VisionTabNames.RunParameters, Description = "设置与源点对应的四个目标坐标点")]
    ...
    protected override FlowableResult<IMatImage> Invoke(Mat fromImage)
    {
        ...
        // 应用透视变换
        Mat dst = new Mat();
        Cv2.WarpPerspective(fromImage, dst, perspectiveMatrix, new OpenCvSharp.Size(400, 300));
        return this.OK(dst);
