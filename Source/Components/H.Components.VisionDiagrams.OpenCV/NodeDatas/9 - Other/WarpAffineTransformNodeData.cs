...
public class WarpAffineTransformNodeData : OpenCVNodeDataBase, IOtherGroupableNodeData
{
    ...
    [Display(Name = "源点", GroupName = VisionTabNames.RunParameters, Description = "设置用于计算仿射矩阵的三个源坐标点")]
    ...
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "目标点", GroupName = VisionTabNames.RunParameters, Description = "设置与源点对应的三个目标坐标点")]
