...
public class DnnSuperres : OpenCVNodeDataBase, IOtherGroupableNodeData
{
    ...
    [Display(Name = "算法类型", GroupName = VisionTabNames.RunParameters)]
    public string Algo
    {
        get { return _algo; }
        set
    ...
    [DefaultValue(4)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "缩放系数", GroupName = VisionTabNames.RunParameters)]
    public int Scale
    {
        get { return _scale; }
        set
    ...
    [ReadOnly(true)]
    [Tab(VisionTabNames.RunParameters)]
    [Display(Name = "模型文件", GroupName = VisionTabNames.RunParameters)]
