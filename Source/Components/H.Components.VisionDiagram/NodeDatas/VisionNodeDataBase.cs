...
public abstract class VisionNodeDataBase : StateNodeDataBase
{
    ...
    [Display(Name = "预览延迟", GroupName = VisionTabNames.FlowParameters, Description = "设置生成图像后预览等待时间")]
    ...
    [DefaultValue(0)]
    [Tab(VisionTabNames.FlowParameters)]
    [Display(Name = "执行延迟", GroupName = VisionTabNames.FlowParameters, Description = "执行完成后等待时间")]
    ...
    [Display(Name = "启用输出历史记录", GroupName = VisionTabNames.DisplayParameters, Description = "用于控制是否输出到历史记录和预览图像")]
