...
namespace H.Components.VisionDiagram.Geometrys;
...
public struct VisionLine
{
    ...
    [Display(Name = "起点", GroupName = VisionTabNames.ResultParameters, Description = "要检测的圆的最大半径 (0表示不限制)")]
    public Point Start { get; set; }
    [Expressionable]
    [Tab(VisionTabNames.ResultParameters)]
    [Display(Name = "终点", GroupName = VisionTabNames.ResultParameters, Description = "要检测的圆的最大半径 (0表示不限制)")]
    public Point End { get; set; }
    [Expressionable]
    [Tab(VisionTabNames.ResultParameters)]
    [Display(Name = "中点", GroupName = VisionTabNames.ResultParameters, Description = "要检测的圆的最大半径 (0表示不限制)")]
