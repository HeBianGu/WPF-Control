...
public struct VisionCircle
{
    ...
    [Display(Name = "圆心", GroupName = VisionTabNames.ResultParameters, Description = "要检测的圆的最大半径 (0表示不限制)")]
    public Point Point { get; set; }
    [Expressionable]
    [Tab(VisionTabNames.ResultParameters)]
    [Display(Name = "半径", GroupName = VisionTabNames.ResultParameters, Description = "要检测的圆的最大半径 (0表示不限制)")]
