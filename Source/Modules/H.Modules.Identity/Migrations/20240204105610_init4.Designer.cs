...
namespace H.Modules.Identity.Migrations
{
    ...
    [Migration("20240204105610_init4")]
    partial class init4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("H.Modules.Identity.hi_dd_author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8715),
                            ISENBLED = 1,
                            Name = "用户管理",
                            UDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8715)
                        },
                        new
                        {
                            ID = "{DE3B4992-A5BF-4AD2-80D8-2C9654C47A34}",
                            CDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8752),
                            ISENBLED = 1,
                            Name = "角色管理",
                            UDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8752)
                        });
                });
            ...
            modelBuilder.Entity("H.Modules.Identity.hi_dd_role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8767),
                            Code = "01",
                            ISENBLED = 1,
                            Name = "管理员",
                            UDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8767)
                        },
                        new
                        {
                            ID = "{0E465AF1-4C5B-417B-B496-E74E8A0D7E5C}",
                            CDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8777),
                            Code = "02",
                            ISENBLED = 1,
                            Name = "普通用户",
                            UDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8777)
                        });
                });
            ...
            modelBuilder.Entity("H.Modules.Identity.hi_dd_user", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "admin",
                            CDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8786),
                            Enable = false,
                            ISENBLED = 1,
                            Name = "超级用户",
                            Password = "123456",
                            RoleID = "{4360CE12-E5F4-4EA6-937C-9FDEA4DF06F6}",
                            UDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8786)
                        },
                        new
                        {
                            ID = "{A8EE1331-0DA7-42F1-80E2-CD2A20D62BC9}",
                            Account = "user",
                            CDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8797),
                            Enable = false,
                            ISENBLED = 1,
                            Name = "HeBianGu",
                            Password = "123456",
                            RoleID = "{0E465AF1-4C5B-417B-B496-E74E8A0D7E5C}",
                            UDATE = new DateTime(2024, 2, 4, 18, 56, 9, 726, DateTimeKind.Local).AddTicks(8797)
                        });
                });
