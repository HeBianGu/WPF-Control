...
{
    public static IServiceCollection AddHome(this IServiceCollection services, Action<IHomeOptions> setupAction = null)
    {
        services.AddOptions();
        services.TryAdd(ServiceDescriptor.Singleton<IHomeViewPresenter, HomeViewPresenter>());
        if (setupAction != null)
