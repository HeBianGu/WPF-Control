    ...
    public static class Extention
    {
        ...
        public static void UseDefaultColorResources(this IApplicationBuilder app, Action<IColorThemeOptions> option = null)
        {
            app.UseThemeOptions(x =>
            {
                ...
                x.ColorResources.Add(new H.Themes.Colors.Copper.CopperColorResource());
                x.ColorResources.Add(new H.Themes.Colors.Copper.VintageFilmColorResource());
                x.ColorResources.Add(new ExecutiveBlueColorResource());
                x.ColorResources.Add(new EnterpriseGrayColorResource());
                x.ColorResources.Add(new FinanceNavyColorResource());
                x.ColorResources.Add(new LegalInkColorResource());
                x.ColorResources.Add(new MedicalCleanColorResource());
                x.ColorResources.Add(new ResearchPaperColorResource());
                x.ColorResources.Add(new CoffeeCreamColorResource());
                x.ColorResources.Add(new VintagePaperColorResource());
                x.ColorResources.Add(new SunsetCoralColorResource());
                x.ColorResources.Add(new AutumnMapleColorResource());
                x.ColorResources.Add(new WarmAmberColorResource());
                x.ColorResources.Add(new BookstoreColorResource());
                x.ColorResources.Add(new CinnamonColorResource());
                x.ColorResources.Add(new OldFilmColorResource());
