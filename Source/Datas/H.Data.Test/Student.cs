...
{
    [ResourceKey("StudentName")]
    [Display(Name = "姓名", GroupName = "基础信息", Description = "学生的姓名")]
    [Required()]
    public string Name { get; set; }

    [Display(Name = "班级", GroupName = "基础信息", Description = "学生的班级")]
    [Required]
    public string Class { get; set; }

    [Display(Name = "地址", GroupName = "基础信息", Description = "学生的地址")]
    [Required]
    public string Address { get; set; }

    [Display(Name = "邮箱", GroupName = "基础信息", Description = "学生的邮箱")]
    [Required]
    public string Emall { get; set; }

    [Display(Name = "可用", GroupName = "其他信息", Description = "学生的可用状态")]
    [Required]
    public bool IsEnbled { get; set; }

    [Display(Name = "时间", GroupName = "其他信息", Description = "学生的时间")]
    [Required]
    public DateTime Time { get; set; }

    [Display(Name = "年龄", GroupName = "基础信息", Description = "学生的年龄")]
    [Required]
    public int Age { get; set; }

    [Display(Name = "分数", GroupName = "成绩信息", Description = "学生的分数")]
    [Range(0.0, 150.0)]
    public double Score { get; set; }

    [Display(Name = "电话号码", GroupName = "基础信息", Description = "学生的电话号码")]
    [Required]
    [RegularExpression(@"^1[3|4|5|7|8][0-9]{9}$", ErrorMessage = "手机号码不合法！")]
    public string Tel { get; set; }

    private string _tag = string.Empty;
    [Display(Name = "标签", GroupName = "基础信息", Description = "学生的标签")]
    [Required]
    public string Tag
    {
        get { return _tag; }
