...
namespace H.Data.Test
{
    ...
    public partial class TestViewModel : TreeNodeBase<DateTime>
    {
        ...
        public static TestViewModels Randoms(int c = 100)
        {
            List<TestViewModel> ss = Enumerable.Range(0, c).Select(x => new TestViewModel()).ToList();
            return new TestViewModels(ss);
        }
    ...
    public class GetTestViewModelsExtension : MarkupExtension
    {
        ...
        {
            return Enumerable.Range(0, this.Count).Select(x => new TestViewModel());
        }
    }
}
