...
\[缺少 "M:H.Services.Common.ProjectExtension.ShowSaveProject(H.Services.Common.IProjectService)" 的 &lt;summary&gt; 文档\]
...
**C#**
``` C#
public static Task<bool?> ShowSaveProject(
...
#### 参数
<dl><dt>  <a href="a9a2aa35-ae71-6583-255d-1826ea81ef74">IProjectService</a></dt><dd>\[缺少 "M:H.Services.Common.ProjectExtension.ShowSaveProject(H.Services.Common.IProjectService)" 的 &lt;param name="projectService"/&gt; 文档\]</dd></dl>
...
\[缺少 "M:H.Services.Common.ProjectExtension.ShowSaveProject(H.Services.Common.IProjectService)" 的 &lt;returns&gt; 文档\]
